    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full `}>
        <div className="flex-1 flex flex-col justify-start mr-10">
          ...
          <p className={`${styles.paragraph} mt-4 max-w-[310px] `}>Una nueva forma de realizar los pagos de forma fácil, fiable y segura.</p>
        </div>
      ...
      <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
        <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-white">2022 HooBank. Todos los derechos reservados.</p>
        <a className="font-poppins font-normal text-center text-[18px] leading-[27px] text-white" href="https://josegutierrez-portafolio.netlify.app/" target="__blank">@Dev_JoseG</a>
